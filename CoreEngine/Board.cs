...
namespace graphedBoard
{
    ...
    class Board
    {
        ...
        public Dictionary<int, Players> GetComponentPlacement()
        {
        ...
        List<int> searchFor(int initial, int max_depth, Players p)
        {
        ...
        public bool moveValidation(Players p, int to, int from)
        {
